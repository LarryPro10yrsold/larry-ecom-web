...
const product = {
  ...
  information: {
    title: 'Master Oogway Statue',
    description:
      'A finely crafted statue of Master Oogway, embodying wisdom and tranquility.',
    price: 49.99,
    currency: 'USD',
    stock: 12,
  },
